...
transcript = "../Araport11_5_utr_20160617"
Length = dict()
...
ax = sns.distplot(dis["length"], rug=True, rug_kws={"color": "g"},
                  kde_kws={"color": "k", "lw": 2, "label": "5' UTR"},
                  hist_kws={"histtype": "step", "linewidth": 2,
                            "alpha": 1, "color": "g"})
ax.set(xlabel="5' UTR length",ylabel="Proportion") 
ax.set(title="The Distribution of 5' UTR of Arabidopsis thaliana")
...
ax = ax.get_figure()
ax.savefig('LengthDistribution5UTR.pdf')
