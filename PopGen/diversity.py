...
def calc_pi_XY(seq_freq1, seq_freq2):
    """
    计算两条序列的多态性
    :param seq_freq1: 序列1的每个碱基频率
    :param seq_freq2: 序列2的每个碱基频率
    :return: 返回多态性和
    """
    pi_XY = 0.0
...
if __name__=="__main__":
    seq_freq1 = calc_seq_freqs("ATGCAT")
    print(seq_freq1)
    seq_freq2 = calc_seq_freqs("ATGGGG")
    print(seq_freq2)
    print(calc_num_diffs("ATGCAT","ATGGGG"))
    print(calc_pi_XY(seq_freq1,seq_freq2))
